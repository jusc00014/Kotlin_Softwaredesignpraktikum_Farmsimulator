...
/**
 * Tests if the Drought has a field/plantation tile in the radius
 */
class InvalidDroughtTest : TestExtension() {
    override val name = "InvalidDroughtTest"
    override val description = "Tests if the Drought has a field/plantation tile in the radius"

    override val map = "scenarioParser/map.json"
    override val farms = "scenarioParser/farms.json"
    override val scenario = "scenarioParser/invalidDroughtScenario.json"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: invalidDroughtScenario.json is invalid.")
    }
}
