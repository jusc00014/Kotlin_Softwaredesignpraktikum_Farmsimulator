 ...
 * Tests apples
 */
class BadAppleEstimateTest19 : TestExtension() {
    override val name = "BadAppleEstimate19Test"
    ...
    override suspend fun run() {
        ...
        assertNextLine(
            "[IMPORTANT] Simulation Statistics: Total harvest estimate still in fields and plantations: 688500 g."
        )
    }
}
