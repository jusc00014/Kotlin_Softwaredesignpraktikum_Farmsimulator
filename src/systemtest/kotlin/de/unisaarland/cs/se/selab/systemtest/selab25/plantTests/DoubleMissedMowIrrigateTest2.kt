...
/**
 * Tests missed irrigate death + mowing
 */
class DoubleMissedMowIrrigateTest2 : TestExtension() {
    override val name = "DoubleMissedMowIrrigateTest2"
    override val description = "Tests if mowing is considered as missed if the plant died of thirst."

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "plantTests/farmsBadApple.json"
    override val scenario = "plantTests/scenario.json"
    override val map = "plantTests/mapDoubleMissedMowIrrigateAction.json"
    ...
    override suspend fun run() {
        ...
        assertCurrentLine("[INFO] Simulation Info: Tick 0 started at tick 7 within the year.")
