...
/**
 * Tests missed irrigate death + cutting
 */
class DoubleMissedTest2 : TestExtension() {
    override val name = "DoubleMissedTest2"
    override val description = "Tests if cutting is considered as missed if the plant died of thirst."

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "plantTests/farmsBadApple.json"
    override val scenario = "plantTests/scenario.json"
    override val map = "plantTests/mapDoubleMissedAction.json"
    ...
    override suspend fun run() {
        ...
        assertCurrentLine("[INFO] Simulation Info: Tick 0 started at tick 16 within the year.")
