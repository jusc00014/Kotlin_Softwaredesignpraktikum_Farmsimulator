 ...
 */
class DoubleMissedWeedIrrigateTest : TestExtension() {
    override val name = "DoubleMissedWeedIrrigateTest"
    ...
    override suspend fun run() {
        ...
        assertNextLine("[DEBUG] Harvest Estimate: Required actions on tile 1 were not performed: WEEDING,IRRIGATING.")
