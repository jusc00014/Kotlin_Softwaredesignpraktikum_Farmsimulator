 ...
 */
class InitializePlantationTick19Test : TestExtension() {
    override val name = "InitializePlantationTick19Test"
    override val description = "Tests if the harvest estimate is set correctly in tick 19 and reduced."
    ...
    override suspend fun run() {
        ...
        assertNextLine(
            "[IMPORTANT] Simulation Statistics: Total harvest estimate still in fields and plantations: 2437350 g."
        )
    }
}
